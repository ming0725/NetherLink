...
public:
    ...
    void setTimestamp(const QDateTime& time) { timestamp = time; }
    void setSenderId(const QString& id) { senderId = id; }
    void setSenderName(const QString& name) { senderName = name; }
    void setIsFromMe(bool from) { isFromMe_ = from; }
    void setIsSelected(bool selected) { isSelected_ = selected; }
    void setInGroupChat(bool inGroup) { inGroupChat_ = inGroup; }
    
    QDateTime getTimestamp() const { return timestamp; }
    QString getSenderId() const { return senderId; }
    QString getSenderName() const { return senderName; }
    bool isFromMe() const { return isFromMe_; }
    bool getIsSelected() const { return isSelected_; }
    bool isInGroupChat() const { return inGroupChat_; }
