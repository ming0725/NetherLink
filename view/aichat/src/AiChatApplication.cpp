    ...
    , m_rightPane(new QStackedWidget(this))
{
    ...
    connect(m_leftPane->chatList(), &AiChatListWidget::chatItemClicked,
            this, &AiChatApplication::onChatItemClicked);
    connect(m_leftPane->chatList(), &AiChatListWidget::chatItemRenamed,
            this, &AiChatApplication::onChatItemRenamed);
    connect(m_leftPane->chatList(), &AiChatListWidget::chatItemDeleted,
            this, &AiChatApplication::onChatItemDeleted);
}
