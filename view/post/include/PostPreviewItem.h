...
public:
    ...
    int getLikeCount() const { return m_likeCount; }
    bool isLiked() const { return m_liked; }
    QString getAuthorAvatarUrl() const { return m_authorAvatarUrl; }
    QString getPostImageUrl() const { return m_postImageUrl; }
    QPixmap getOriginalImage() { return m_originalImage; }

    // Setters
    void setAuthorName(const QString& name) { m_authorName = name; }
    void setAuthorID(const QString& id) { m_authorID = id; }
    void setTitle(const QString& title) { m_titleText = title; }
    void setLikeCount(int count) { m_likeCount = count; }
    void setLiked(bool liked) { m_liked = liked; }
    void setAuthorAvatarUrl(const QString& url) { m_authorAvatarUrl = url; }
    void setPostImageUrl(const QString& url) { m_postImageUrl = url; }
