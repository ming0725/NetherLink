    ...
    : FramelessWindow(parent)
{
    ...
    this->closeButton->setIcon(QIcon(":/resources/icon/close.png"));
    this->closeButton->setIconSize(QSize(30, 30));
    this->closeButton->setFlat(true);
    this->closeButton->setCursor(Qt::PointingHandCursor);
    this->closeButton->setStyleSheet(QString(
        "QPushButton:pressed {"
        "  background: none;"
        "  border: none;"
        "}"
    ));
    connect(this->closeButton, &QPushButton::clicked, this, &Register::close);
    ...
    // 设置默认头像并使其圆形
    QPixmap defaultAvatar(":/resources/icon/icon.png");
    ...
    this->usernameEdit->setIcon(QPixmap(":/resources/icon/skull.png"));
    this->verificationCodeEdit->setIcon(QPixmap(":/resources/icon/lock.png"));
    this->nicknameEdit->setIcon(QPixmap(":/resources/icon/skull.png"));
    this->passwordEdit->setIcon(QPixmap(":/resources/icon/lock.png"));
    this->confirmPasswordEdit->setIcon(QPixmap(":/resources/icon/lock.png"));
    ...
    // 验证码按钮
    this->getCodeButton = new QPushButton("获取验证码", this);
    ...
    this->getCodeButton->setStyleSheet(QString(
        "QPushButton {"
    ...
    this->registerButton->setStyleSheet(QString(
        "QPushButton {"
        "  background-color: #0099ff;"
        "  color: white;"
        "  border: none;"
    ...
    // 连接信号槽
    connect(this->getCodeButton, &QPushButton::clicked, this, [this]() {
    ...
    connect(this->registerButton, &QPushButton::clicked, this, [this]() {
