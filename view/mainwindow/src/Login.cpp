        ...
        : FramelessWindow(parent)
{
    ...
    QPixmap icon(":/resources/icon/icon.png");
    ...
    this->userAccountEdit->setIcon(QPixmap(":/resources/icon/skull.png"));
    this->userPasswordEdit->setIcon(QPixmap(":/resources/icon/lock.png"));
    ...
    this->loginButton->setStyleSheet(QString(
            "QPushButton {"
