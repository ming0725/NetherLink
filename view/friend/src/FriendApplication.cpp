...
FriendLeftPane::FriendLeftPane(QWidget* parent)
    : QWidget(parent)
    , m_topSearch(new TopSearchWidget(this))
    , m_friendNotification(new NotificationItem("好友通知", this))
    , m_groupNotification(new NotificationItem("群通知", this))
    , m_content(new FriendListWidget(this))
{
    ...
    connect(m_friendNotification, &NotificationItem::clicked,
            this, &FriendLeftPane::friendNotificationClicked);
    connect(m_groupNotification, &NotificationItem::clicked,
            this, &FriendLeftPane::groupNotificationClicked);

    // 连接好友请求信号
    connect(&NetworkManager::instance(), &NetworkManager::friendRequestReceived,
            this, [this](int, const QString&, const QString&,
        ...
        : QWidget(parent)
{
    ...
    // 连接通知点击信号
    connect(m_leftPane, &FriendLeftPane::friendNotificationClicked,
            this, &FriendApplication::onFriendNotificationClicked);
    connect(m_leftPane, &FriendLeftPane::groupNotificationClicked,
            this, &FriendApplication::onGroupNotificationClicked);
