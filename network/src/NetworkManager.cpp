...
NetworkManager::NetworkManager(QObject* parent)
        : QObject(parent),
          ...
          m_wss(new QWebSocket())
{
    // HTTP
    connect(m_http, &QNetworkAccessManager::finished,
            this, &NetworkManager::onHttpFinished, Qt::QueuedConnection);

    // WSS 信号（都在主线程）
    connect(m_wss, &QWebSocket::connected,
            this, &NetworkManager::onWssConnected, Qt::QueuedConnection);
    connect(m_wss, &QWebSocket::disconnected,
            this, &NetworkManager::wssDisconnected, Qt::QueuedConnection);
    connect(m_wss, &QWebSocket::textMessageReceived,
            this, &NetworkManager::onWssTextMessage, Qt::QueuedConnection);
    connect(m_wss, &QWebSocket::errorOccurred,
            this, &NetworkManager::onWssErrorOccurred, Qt::QueuedConnection);
    connect(m_wss,
