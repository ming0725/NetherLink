...
Register::Register(QWidget* parent) : FramelessWindow(parent) {
    ...
    this->getCodeButton->setStyleSheet(QString("QPushButton {""  background-color: #0099ff;""  color: white;""  border: none;""  border-radius: 20px;""  font-size: 13px;""}""QPushButton:pressed {""  background-color: #0088ee;""}""QPushButton:disabled {""  background-color: #cccccc;""}"));
    ...
    this->registerButton->setStyleSheet(QString("QPushButton {""  background-color: #0099ff;""  color: white;""  border: none;""  border-radius: 20px;""  font-size: 15px;""}""QPushButton:pressed {""  background: none;""  border: none;""}"));
