...
#include "../../../include/View/Chat/ChatItemDelegate.h"
...
static constexpr auto qt_meta_stringdata_CLASSChatItemDelegateENDCLASS = QtMocHelpers::stringData(
    "ChatItemDelegate",
    "onAvatarLoaded",
    "",
    "userId",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSChatItemDelegateENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSChatItemDelegateENDCLASS_t qt_meta_stringdata_CLASSChatItemDelegateENDCLASS = {
    {
        QT_MOC_LITERAL(0, 16),  // "ChatItemDelegate"
        QT_MOC_LITERAL(17, 14),  // "onAvatarLoaded"
        QT_MOC_LITERAL(32, 0),  // ""
        QT_MOC_LITERAL(33, 6),  // "userId"
...
void ChatItemDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onAvatarLoaded((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QPixmap>>(_a[2]))); break;
        default: ;
        }
    }
}
