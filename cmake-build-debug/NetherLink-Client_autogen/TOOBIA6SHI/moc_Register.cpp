...
#include "../../../include/View/Mainwindow/Register.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSRegisterENDCLASS_t qt_meta_stringdata_CLASSRegisterENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(9, 15),  // "registerSuccess"
        QT_MOC_LITERAL(25, 0),  // ""
...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->registerSuccess((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Register::*)(const QString & , const QString & );
            if (_t _q_method = &Register::registerSuccess; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Register::registerSuccess(const QString & _t1, const QString & _t2)
{
