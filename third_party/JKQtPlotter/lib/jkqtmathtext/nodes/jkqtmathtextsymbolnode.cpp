/*
    ...
    Changes: adjusted integral-like symbol rendering properties; see
...
const QHash<QString, JKQTMathTextSymbolNode::SymbolFullProps> &JKQTMathTextSymbolNode::symbols()
{
    static QHash<QString, JKQTMathTextSymbolNode::SymbolFullProps> s_symbols=[](){
        ...
        symbols["iiint"]=NarrowMathOperatorSymbolUnicode(QChar(0x222D)).addMathOperatorUnicode(QChar(0x222D), 1.28, 0.0).addGlobalFlags(IntLikeSymbolCorrection).addMathOperatorHtml("&tint;").addMathOperatorWinSymbol(QString(3, QChar(0xF2)), 1.8, 0.1);
        symbols["iint"]=NarrowMathOperatorSymbolUnicode(QChar(0x222C)).addMathOperatorUnicode(QChar(0x222C), 1.28, 0.0).addGlobalFlags(IntLikeSymbolCorrection).addMathOperatorHtml("&Int;").addMathOperatorWinSymbol(QString(2, QChar(0xF2)), 1.8, 0.1);
        symbols["in"]=MathOperatorSymbolUnicode(QChar(0x2208)).addMathOperatorHtml("&isin;").addMathOperatorWinSymbol(QChar(0xCE));
        symbols["int"]=NarrowMathOperatorSymbolUnicode(QChar(0x222B)).addMathOperatorUnicode(QChar(0x222B), 1.28, 0.0).addGlobalFlags(IntLikeSymbolCorrection).addMathOperatorHtml("&int;").addMathOperatorWinSymbol(QChar(0xF2), 1.8, 0.1);
        ...
        symbols["oiiint"]=NarrowMathOperatorSymbolUnicode(QChar(0x2230)).addMathOperatorUnicode(QChar(0x2230), 1.28, 0.0).addGlobalFlags(IntLikeSymbolCorrection).addMathOperatorHtml("&Cconint;");
        symbols["oiint"]=NarrowMathOperatorSymbolUnicode(QChar(0x222F)).addMathOperatorUnicode(QChar(0x222F), 1.28, 0.0).addGlobalFlags(IntLikeSymbolCorrection).addMathOperatorHtml("&DoubleContourIntegral;");
        symbols["oint"]=NarrowMathOperatorSymbolUnicode(QChar(0x222E)).addMathOperatorUnicode(QChar(0x222E), 1.28, 0.0).addGlobalFlags(IntLikeSymbolCorrection).addMathOperatorHtml("&ContourIntegral;");
