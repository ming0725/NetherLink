...
class JKQTMATHTEXT_LIB_EXPORT JKQTMathTextLatexParser : public JKQTMathTextParser {
    ...
    protected:
        ...
        /** \brief parses one math argument, either a {...} group or a single token */
        JKQTMathTextNode* parseMathArgument(bool get, bool *foundError=nullptr, bool* getNew=nullptr);
